...
ALTER ROLE postgres WITH PASSWORD 'zF9-IP9FjdJ376zbMG_n';
...
DROP DATABASE "skyriseretelldb";
--
-- Name: skyriseretelldb; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE skyriseretelldb WITH OWNER = postgres;WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Arabic_Egypt.1252';


ALTER DATABASE "skyriseretelldb" OWNER TO postgres;

\unrestrict 0gvKwstbKwBvoVRUHXP9xdJrKEObkB3bNDEw3dUSWWsXaAykewnDmqR5ybSNBPs
\connect skyriseretelldb
\restrict 0gvKwstbKwBvoVRUHXP9xdJrKEObkB3bNDEw3dUSWWsXaAykewnDmqR5ybSNBPs
